        ...
        <div className='mt-16 px-1'>
            {Array.isArray(userData) && userData.length > 0 ? (
                userData.map((person,id) => (
                    <div key={id} className="border-none sm:p-4 p-2 mb-10 text-white rounded-lg shadow-md flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-10" style={{ backgroundColor: 'rgb(252 181 1 / 16%)'}}>
